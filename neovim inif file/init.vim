...
" Ini adalah blok untuk transparent.nvim
...
" Plugin Ikon (Wajib ditaruh PALING BAWAH di daftar plugin)
...
local function clear_bg()
  local groups = {
    ...
    "EndOfBuffer", "MsgArea", 
    "Pmenu", "NormalFloat", "FloatBorder",
    "ColorColumn", "FoldColumn", "Folded",
    "WinSeparator", "VertSplit",

    -- --- TAMBAHAN UNTUK BARIS ATAS (BUFFERLINE / BARBAR) ---
    "TabLine", "TabLineFill", "TabLineSel", -- Bawaan Nvim
    "BufferLineFill", "BufferLineBackground", "BufferLineSeparator", -- Untuk Bufferline
    "BufferCurrent", "BufferVisible", "BufferInactive", "BufferFill" -- Untuk Barbar
  }
  
  for _, group in ipairs(groups) do
    -- Kita pakai pcall (protected call) supaya kalau pluginnya gak ada, Nvim gak error
